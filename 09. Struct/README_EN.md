...
| **9e** | Passing structs to functions (by value, by reference) | [`9e.cpp`](./9e.cpp) | – |

---

### 📝 Notes
- **9a** only explains the concept; no code file.
- All programs use **pure C++**, compiled with `g++`.
- Focus on creating custom data types with `struct`.