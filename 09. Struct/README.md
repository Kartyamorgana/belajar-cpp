...
| **9e** | Passing struct ke fungsi (by value, by reference) | [`9e.cpp`](./9e.cpp) | – |

---

### 📝 Catatan
- **9a** hanya penjelasan konsep, tidak ada file kode.
- Semua program menggunakan **C++ murni**, dikompilasi dengan `g++`.
- Fokus pada pembuatan tipe data buatan sendiri dengan `struct`.