...
### 📝 Notes
- All programs are written in **pure C++**, compiled with `g++`, and run in the terminal.
- Focus on declaration, initialization, and basic operations for each data type.
- Use `std::cout` for output and `std::cin` for input (2f).